...
Invoke the spec-driven-development skill alongside explore-then-ask skill.

Begin by understanding what the user wants to build. Use explore-then-ask skill to Ask clarifying questions about:
